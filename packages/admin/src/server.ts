...
import type { ClientToServerEvents, ServerToClientEvents } from './views/conference/types'

const privateKey = fs.readFileSync('./src/localhost+3-key.pem')
const certificate = fs.readFileSync('./src/localhost+3.pem')
